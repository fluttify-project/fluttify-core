...
public class ObjectiveCParser extends Parser {
	...
	public final DeclaratorSuffixContext declaratorSuffix() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 38)) & ~0x3f) == 0 && ((1L << (_la - 38)) & ((1L << (TRUE - 38)) | (1L << (FALSE - 38)) | (1L << (BOOL - 38)) | (1L << (Class - 38)) | (1L << (BYCOPY - 38)) | (1L << (BYREF - 38)) | (1L << (ID - 38)) | (1L << (IMP - 38)) | (1L << (IN - 38)) | (1L << (INOUT - 38)) | (1L << (NIL - 38)) | (1L << (NO - 38)) | (1L << (ONEWAY - 38)) | (1L << (OUT - 38)) | (1L << (PROTOCOL_ - 38)) | (1L << (SEL - 38)) | (1L << (SELF - 38)) | (1L << (SUPER - 38)) | (1L << (YES - 38)) | (1L << (ATOMIC - 38)) | (1L << (NONATOMIC - 38)) | (1L << (RETAIN - 38)) | (1L << (AUTORELEASING_QUALIFIER - 38)) | (1L << (BLOCK - 38)) | (1L << (BRIDGE_RETAINED - 38)) | (1L << (BRIDGE_TRANSFER - 38)) | (1L << (COVARIANT - 38)) | (1L << (CONTRAVARIANT - 38)) | (1L << (DEPRECATED - 38)) | (1L << (KINDOF - 38)) | (1L << (UNUSED - 38)) | (1L << (NULL_UNSPECIFIED - 38)) | (1L << (NULLABLE - 38)) | (1L << (NONNULL - 38)))) != 0) || ((((_la - 102)) & ~0x3f) == 0 && ((1L << (_la - 102)) & ((1L << (NULL_RESETTABLE - 102)) | (1L << (NS_INLINE - 102)) | (1L << (NS_ENUM - 102)) | (1L << (NS_OPTIONS - 102)) | (1L << (ASSIGN - 102)) | (1L << (COPY - 102)) | (1L << (GETTER - 102)) | (1L << (SETTER - 102)) | (1L << (STRONG - 102)) | (1L << (READONLY - 102)) | (1L << (READWRITE - 102)) | (1L << (WEAK - 102)) | (1L << (UNSAFE_UNRETAINED - 102)) | (1L << (IB_OUTLET - 102)) | (1L << (IB_OUTLET_COLLECTION - 102)) | (1L << (IB_INSPECTABLE - 102)) | (1L << (IB_DESIGNABLE - 102)) | (1L << (IDENTIFIER - 102)) | (1L << (ADD - 102)) | (1L << (SUB - 102)))) != 0) || ((((_la - 171)) & ~0x3f) == 0 && ((1L << (_la - 171)) & ((1L << (CHARACTER_LITERAL - 171)) | (1L << (HEX_LITERAL - 171)) | (1L << (OCTAL_LITERAL - 171)) | (1L << (BINARY_LITERAL - 171)) | (1L << (DECIMAL_LITERAL - 171)) | (1L << (FLOATING_POINT_LITERAL - 171)) | (1L << (NULL_ - 171)))) != 0)) {
				{
				setState(1181);
				constantExpression();
				}
	...
	public static final String _serializedATN =
		...
		"\62\2\2\u0691\u0697\7\u00e1\2\2\u0692\u0697\7;\2\2\u0693\u0697\7\63\2"+
		"\2\u0694\u0697\7(\2\2\u0695\u0697\7)\2\2\u0696\u0684\3\2\2\2\u0696\u0685"+
		"\3\2\2\2\u0696\u0686\3\2\2\2\u0696\u0688\3\2\2\2\u0696\u068c\3\2\2\2\u0696"+
		"\u068f\3\2\2\2\u0696\u0690\3\2\2\2\u0696\u0691\3\2\2\2\u0696\u0692\3\2"+
		"\2\2\u0696\u0693\3\2\2\2\u0696\u0694\3\2\2\2\u0696\u0695\3\2\2\2\u0697"+
		"\u011d\3\2\2\2\u0698\u069c\7\u00ae\2\2\u0699\u069b\t\25\2\2\u069a\u0699"+
		"\3\2\2\2\u069b\u069e\3\2\2\2\u069c\u069a\3\2\2\2\u069c\u069d\3\2\2\2\u069d"+
		"\u069f\3\2\2\2\u069e\u069c\3\2\2\2\u069f\u06a1\7\u00ba\2\2\u06a0\u0698"+
		"\3\2\2\2\u06a1\u06a2\3\2\2\2\u06a2\u06a0\3\2\2\2\u06a2\u06a3\3\2\2\2\u06a3"+
		"\u011f\3\2\2\2\u06a4\u06a5\t\26\2\2\u06a5\u0121\3\2\2\2\u00e1\u0125\u0135"+
		"\u013c\u0142\u0148\u014b\u014e\u0156\u015d\u0160\u0163\u016b\u016e\u0171"+
		"\u017b\u0185\u018d\u0192\u019b\u01a1\u01a3\u01af\u01b9\u01c1\u01c4\u01c7"+
		"\u01d0\u01e7\u01ee\u01f1\u01f7\u0200\u0206\u0208\u0211\u0213\u021c\u0220"+
		"\u0229\u022b\u0234\u0238\u023b\u0243\u0247\u0249\u024c\u0252\u0256\u025c"+
