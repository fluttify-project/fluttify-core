...
class PlatformViewFactoryTmpl(
    ...
    private val hTmpl = this::class.java.getResource("/tmpl/objc/platform_view_factory.h.tmpl").readText()
    private val mTmpl = this::class.java.getResource("/tmpl/objc/platform_view_factory.m.tmpl").readText()
