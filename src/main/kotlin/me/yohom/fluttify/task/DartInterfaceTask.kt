    ...
    fun process() {
        ...
        project.projectDir.iterate("java") {
            ...
            if (androidViewBuilder.toString().isNotBlank()) {
                "${androidDirPath}android_${it.javaType().name.simpleName().camel2Underscore()}.dart".file()
    ...
    fun process() {
        ...
        project.projectDir.iterate("h") {
            ...
            if (uikitViewBuilder.toString().isNotBlank()) {
                "${iOSDirPath}ios_${it.nameWithoutExtension}.dart".file()
            ...
            val result = "$imports\n$withoutImports"
            "$iOSDirPath${it
                .toRelativeString(FluttifyCorePluginExtension.frameworkDirPath.file())
                .substringBeforeLast(".")
                .replace("$", "_")}.dart"
                .file()
