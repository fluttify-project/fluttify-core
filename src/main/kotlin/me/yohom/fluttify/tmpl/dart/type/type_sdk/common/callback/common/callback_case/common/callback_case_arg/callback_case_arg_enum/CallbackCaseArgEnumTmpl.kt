...
//#__arg_type_name__#.values[args['#__arg_name__#'] - #__offset__#]
...
fun CallbackCaseArgEnumTmpl(param: Parameter): String {
    return tmpl
        ...
        .replace("#__offset__#", param.variable.trueType.findType().run {
            if (enumerators.isNotEmpty()) enumerators[0].value.toString() else "0"
        })
}