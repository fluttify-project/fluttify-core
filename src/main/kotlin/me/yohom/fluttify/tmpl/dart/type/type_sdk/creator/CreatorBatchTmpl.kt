...
//  }
//  final List<int> resultBatch = await MethodChannel('#__channel_name__#').invokeMethod('ObjectFactory::create_batch#__creator_name__#'#__separator__##__args__#);
//
...
//                    )
                    ...
                    .replace("#__formal_params__#", it.formalParams.joinToString { it.variable.toDartStringBatch() })
